...
class room_hotel_3 extends StatefulWidget {
  const room_hotel_3({super.key});

  @override
  State<room_hotel_3> createState() => _RoomState();
}

class _RoomState extends State<room_hotel_3> {
  @override
            ...
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/room3.webp"),
                  fit: BoxFit.fill,
                ),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bedroom3.jpg"),
                  fit: BoxFit.fill,
                ),
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(10),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bathroom3.jpg"),
                  fit: BoxFit.fill,
                ),
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(10),
