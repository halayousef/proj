...
class room_hotel_4 extends StatefulWidget {
  const room_hotel_4({super.key});

  @override
  State<room_hotel_4> createState() => _RoomState();
}

class _RoomState extends State<room_hotel_4> {
  @override
            ...
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/livingarea.jpg"),
                  fit: BoxFit.fill,
                ),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bedroom4.jpg"),
                  fit: BoxFit.fill,
                ),
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(10),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bathroom4.jpg"),
                  fit: BoxFit.fill,
                ),
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(10),
