...
class room_hotel_1 extends StatefulWidget {
  const room_hotel_1({super.key});

  @override
  State<room_hotel_1> createState() => _RoomState();
}

class _RoomState extends State<room_hotel_1> {
  @override
            ...
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/room_1.jpg"),
                  fit: BoxFit.fill,
                ),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bed_1.jpg"),
                  fit: BoxFit.fill,
                ),
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(10),
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage("images/bathroom_1.jpg"),
                  fit: BoxFit.fill,
                ),
                borderRadius: BorderRadius.only(
                  topRight: Radius.circular(10),
